#!/bin/bash
#SBATCH -J BC_ext_GlyEtOH_2N_20170616  #job name for array
...
python extract_bcs_V4.py ../GlyEtOH_2N_20170616/sample_index.txt ../GlyEtOH_2N_20170616 underscore bc_counts/GlyEtOH_2N_20170616_ "${SLURM_ARRAY_TASK_ID}" 5
