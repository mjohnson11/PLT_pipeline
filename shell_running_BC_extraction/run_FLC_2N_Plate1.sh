#!/bin/bash
#SBATCH -J BC_ext_FLC_2N_Plate1  #job name for array
...
python extract_bcs_V4.py ../FLC_2N_Plate1/sample_index.txt ../FLC_2N_Plate1 underscore bc_counts/FLC_2N_Plate1_ "${SLURM_ARRAY_TASK_ID}" 5
