#!/bin/bash
#SBATCH -J BC_ext_FLC_2N_Plate2  #job name for array
...
python extract_bcs_V4.py ../FLC_2N_Plate2/sample_index.txt ../FLC_2N_Plate2 underscore bc_counts/FLC_2N_Plate2_ "${SLURM_ARRAY_TASK_ID}" 5
