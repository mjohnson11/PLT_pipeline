#!/bin/bash
#SBATCH -J BC_ext_CLM_2N_Batch2  #job name for array
...
python extract_bcs_V4.py ../CLM_2N_Batch2/sample_index.txt ../CLM_2N_Batch2 dot bc_counts/CLM_2N_Batch2_ "${SLURM_ARRAY_TASK_ID}" 5
