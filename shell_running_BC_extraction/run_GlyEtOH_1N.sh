#!/bin/bash
#SBATCH -J BC_ext_GlyEtOH_1N  #job name for array
...
python extract_bcs_V4.py ../GlyEtOH_1N/sample_index.txt ../GlyEtOH_1N dot bc_counts/GlyEtOH_1N_ "${SLURM_ARRAY_TASK_ID}" 5
