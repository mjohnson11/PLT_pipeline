#!/bin/bash
#SBATCH -J BC_ext_CLM_clones_1N  #job name for array
...
python extract_bcs_V4.py ../CLM_clones_1N/sample_index.txt ../CLM_clones_1N underscore bc_counts/CLM_clones_1N_ "${SLURM_ARRAY_TASK_ID}" 5
