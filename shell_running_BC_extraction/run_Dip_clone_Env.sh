#!/bin/bash
#SBATCH -J BC_ext_Dip_clone_Env  #job name for array
...
python extract_bcs_V4.py ../Dip_clone_Env/sample_index.txt ../Dip_clone_Env underscore bc_counts/Dip_clone_Env_ "${SLURM_ARRAY_TASK_ID}" 5
