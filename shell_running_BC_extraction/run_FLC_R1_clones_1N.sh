#!/bin/bash
#SBATCH -J BC_ext_FLC_R1_clones_1N  #job name for array
...
python extract_bcs_V4.py ../FLC_R1_clones_1N/sample_index.txt ../FLC_R1_clones_1N underscore bc_counts/FLC_R1_clones_1N_ "${SLURM_ARRAY_TASK_ID}" 5
